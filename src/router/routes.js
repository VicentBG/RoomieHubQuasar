const routes = [
  {
    ...
    children: [
      ...
      { path: 'roomies', name: 'Roomies', component: () => import('pages/RoomiesPage.vue') },
      { path: 'piso', name: 'Piso', component: () => import('pages/PisoPage.vue') },
      { path: 'tareas', name: 'Tareas', component: () => import('pages/TareasPage.vue') },
